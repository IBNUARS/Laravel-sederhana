  ...
  <body id="page-top">
    ...
    <header class="masthead bg-primary text-white text-center">
      <div class="container d-flex align-items-center flex-column">
        ...
        <img class="masthead-avatar mb-5" src="{{ Storage::url($jumbotron->thumbnile) }}" alt="..." />
        <!-- Masthead Heading-->
        <h1 class="masthead-heading text-uppercase mb-0">{{$jumbotron->tittle}}</h1>
        <!-- Icon Divider-->
        ...
        <div class="row justify-content-center">
          ...
          <div class="col-md-6 col-lg-4 mb-5">
            <div class="portfolio-item mx-auto" data-bs-toggle="modal" data-bs-target="#portfolioModal{{$i}}">
              ...
              <img class="img-fluid" src="{{ Storage::url($item->thumbnile) }}" alt="..." />
            </div>
          </div>
          <!-- last partner {{$i}}-->
          @php
    ...
    <section class="page-section bg-primary text-white mb-0" id="about">
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-3 ms-auto text-center"><img src="{{ Storage::url($about->thumbnile) }}" class="w-75" /></div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-4 mb-5 mb-lg-0">
            ...
            @if ($twitter)
            <a class="btn btn-outline-light btn-social mx-1" href="{{ $twitter }}" target="blank"><i 
            ...
            <div class="container">
              <div class="row justify-content-center">
                <div class="col-lg-8">
                  ...
                  <!-- Partner Modal - Image-->
                  <img class="img-fluid rounded mb-5" src="{{ Storage::url($item->thumbnile)}}" alt="..." />
                  <!-- Partner Modal - Text-->
                  {!! $item->content !!}
                  <div class="m-5">
